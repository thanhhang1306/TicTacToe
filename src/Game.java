...
public class Game  extends JPanel implements Runnable, KeyListener, MouseListener, MouseMotionListener{
	...
	private ImageIcon menu, menu2, game, rule, b1, b2, b3, b4, oneWin, twoWin, tie, dino, human;
	...
	public Game() {
		...
		game = new ImageIcon("background_org.png");
		b1 = new ImageIcon("4.png");
		b2 = new ImageIcon("5.png");
		b3 = new ImageIcon("6.png");
		b4 = new ImageIcon("7.png");
		dino = new ImageIcon("dino1.png");
		human = new ImageIcon("human1.png");
		tie = new ImageIcon("8.png");
		oneWin = new ImageIcon("9.png");
		twoWin = new ImageIcon("10.png");
	...
	public void backGround(Graphics g){
		...
		case 'A': 
			...
			break;
		case 'B':
			g.drawImage(b1.getImage(), 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, this);
			break;
		case 'C': 
			g.drawImage(b2.getImage(), 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, this);
			break;
		case 'D': 
			g.drawImage(b3.getImage(), 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, this);
			break;
		case 'E': 
			g.drawImage(b4.getImage(), 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, this);
			break;
		}
	}
	...
	public void drawPanel(Graphics g){
		...
		case 'G': 
			...
			break;
		case 'O': 
			g.drawImage(oneWin.getImage(), 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, this);
			restart();
			break;
		case 'S':
			g.drawImage(twoWin.getImage(), 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, this);
			restart();
			break;
		case 'T': 
	...
	public void drawArrow(Graphics g){
		if (turn %2 == 0)
			g.drawImage(dino.getImage(), x_Cor, y_Cor, BOX_SIZE/3, BOX_SIZE/2, this);
		else g.drawImage(human.getImage(), x_Cor, y_Cor, 50, 75, this);
	}
	...
	public void drawValue(int col, int row, Graphics g){
		...
		if (board.getValues(col, row).equals("X"))
			g.drawImage(dino.getImage(), BOX_SIZE*col + BOX_SIZE/3 , BOX_SIZE*row + BOX_SIZE/4, BOX_SIZE/3, BOX_SIZE/2, this);
		if (board.getValues(col, row).equals("O"))
			g.drawImage(human.getImage(), BOX_SIZE*col + BOX_SIZE/3 , BOX_SIZE*row + BOX_SIZE/4, BOX_SIZE/3, BOX_SIZE/2, this);
	}
	...
	public void mouseClicked(MouseEvent arg0) {
		...
		case 'M': 
			...
			break;
		case 'R': 
			if (arg0.getY()>164 && arg0.getY()<236){
				if (arg0.getX()>382 && arg0.getX()<592)
					screen = 'M';
			}
			break;
		case 'P':
